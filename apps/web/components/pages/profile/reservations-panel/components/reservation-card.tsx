    ...
    <>
      ...
      >
        <div className="flex gap-2 items-start">
          <div className="flex flex-col border-1 border-default-200/50 rounded-sm text-center w-16 overflow-hidden">
            <div className="text-small bg-default-100 py-0.5 text-gray-500">
              {dayjs(data.reservation_time).format('MMM')}
            </div>
            <div className="flex items-center justify-center font-semibold text-[21px] h-9 text-gray-500">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-small text-gray-500">
              ...
              <span className="text-[12px] text-gray-500"> ({upperFirst(data.seat_type)} seat)</span>
            </p>
            <p className="text-small text-gray-500">{dayjs(data.reservation_time).format('h:mm A')}</p>
          </div>
        </div>
