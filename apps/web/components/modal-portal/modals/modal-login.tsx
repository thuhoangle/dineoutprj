...
export const ModalLogin: FC<ModalLoginProps> = ({ isVisible, closeFromController, onOpenChange }) => {
  const {
    email,
    setEmail,
    errorEmail,
  ...
  const TogglePasswordVisibility = ({ isVisible, setIsVisible }: any) => {
    return (
    ...
    >
      ...
      <div className="flex flex-col gap-5 w-full">
        ...
        <Input
          ...
          endContent={<TogglePasswordVisibility isVisible={isPwVisible} setIsVisible={setIsPwVisible} />}
        />
