  ...
  ({
    ...
    return (
      <button
        disabled={disabled}
        className={clsx(
          'relative w-full my-0.5 flex items-center gap-2 rounded-md px-4 py-2 transition duration-200 ease-in hover:bg-gray-200 disabled:opacity-50',
          isSelected ? 'bg-gray-100 text-red-600' : ''
        )}
        onClick={_onClick}
      >
