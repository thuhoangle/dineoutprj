...
export const ModalDeleteTable: FC<ModalDeleteTableProps> = ({ handleDelete, closeFromController, isVisible }) => {
  return (
    <SimpleModal hideModalCB={closeFromController} isVisible={isVisible} showCloseIcon>
      <ModalHeader title="Delete Table" />
      <div className="pb-6 pt-5 text-neutral-800">Are you sure you want to delete this table?</div>
